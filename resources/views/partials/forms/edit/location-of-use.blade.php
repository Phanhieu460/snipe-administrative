...
<div class="form-group {{ $errors->has('location_of_use') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7 col-sm-12">
        <input class="form-control" style="width:100%;" type="text" name="location_of_use"
               placeholder="{{ trans('general.location_of_use_placeholder') }}"
               aria-label="location_of_use" id="location_of_use"
               value="{{ old('location_of_use') }}"
               maxlength="191" />
