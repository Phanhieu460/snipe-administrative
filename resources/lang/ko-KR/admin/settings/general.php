...
return [
    ...
    'auto_incrementing_help'    => '이것을 설정하려면 먼저 자동 증가 자산 태그를 활성화하세요.',
    'backups'					=> '예비품',
    ...
    'ldap_default_group_info'   => '새로 동기화된 사용자에게 할당할 그룹을 선택하세요. 사용자는 할당된 그룹의 권한을 갖게 됩니다.',
...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'security' => '보안',
    'security_title' => '보안 설정 업데이트',
    'security_help' => '이중 인증, 비밀번호 제한',
    'groups_help' => '계정 권한 그룹',
    'localization' => '지역화',
    'localization_title' => '지역화 설정 업데이트',
    'localization_help' => '언어, 날짜 표시',
    'notifications' => '알림',
    'notifications_help' => '이메일 알림 및 감사 설정',
    'asset_tags_help' => '증가 및 접두사',
    'labels' => '라벨',
    'labels_title' => '라벨 설정 업데이트',
    'labels_help' => '바코드 및 라벨 설정',
    ...
    'label2_enable'           => '새 라벨 엔진',
    'label2_enable_help'      => '새 라벨 엔진으로 전환합니다. <b>참고: 다른 설정을 하기 전에 이 설정을 저장해야 합니다.</b>',
