...
return [
    ...
    'user_deactivated'  => '사용자가 로그인할 수 없습니다.',
    'user_activated'  => '사용자가 로그인할 수 있습니다.',
    'activation_status_warning' => 'Do not change activation status',
    'group_memberships_helpblock' => '슈퍼 관리자만 그룹 멤버십을 편집할 수 있습니다.',
    'superadmin_permission_warning' => '슈퍼 관리자만 사용자에게 슈퍼 관리자 권한을 부여할 수 있습니다.',
    'admin_permission_warning' => '관리자 권한 이상을 가진 사용자만 사용자에게 관리자 권한을 부여할 수 있습니다.',
    'remove_group_memberships' => '그룹 멤버십을 제거합니다.',
    'warning_deletion_information' => 'You are about to checkin ALL items from the :count user(s) listed below. Super admin names are highlighted in red.',
    'update_user_assets_status' => 'Update all assets for these users to this status',
    'checkin_user_properties' => 'Check in all properties associated with these users',
    'remote_label'   => '이것은 원격 사용자',
    'remote'   => 'Remote',
    'remote_help' => '이것은 물리적 위치에 거의 또는 전혀 오지 않는 원격 사용자를 기준으로 필터링해야 하는 경우에 유용할 수 있습니다.',
    'not_remote_label' => '이것은 원격 사용자가 아닙니다.',
    'vip_label' => 'VIP 사용자',
    'vip_help' => '이것은 특별한 방법으로 처리하고 싶을 경우 조직에서 중요한 사람들을 표시하는 데 유용할 수 있습니다.',
    'create_user' => '사용자 생성',
