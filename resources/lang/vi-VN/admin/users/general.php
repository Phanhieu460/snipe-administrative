...
return [
    ...
    'users_notified'    => 'Người dùng đã nhận được email chứa danh sách các thiết bị hiện tại mà họ đang sử dụng. | :count người dùng đã nhận được email chứa danh sách các thiết bị hiện tại mà họ đang sử dụng..',
