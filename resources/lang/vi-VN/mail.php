...
return [
    ...
    'item' => 'Mục',
    'item_checked_reminder' => 'Đây là lời nhắc rằng bạn hiện đang có :count thiết bị được cấp phát mà bạn chưa chấp nhận hoặc từ chối. Vui lòng nhấp vào liên kết bên dưới để xác nhận quyết định của bạn.',
    ...
    'read_the_terms_and_click' => 'Vui lòng đọc các điều khoản sử dụng bên dưới và nhấp vào liên kết ở cuối để xác nhận rằng bạn đã đọc, đồng ý với các điều khoản sử dụng và đã nhận thiết bị.',
    ...
    'unaccepted_asset_reminder' => 'Bạn có thiết bị chưa được chấp nhận.',
    ...
    'mail_sent' => 'Gửi email thành công!',
];
